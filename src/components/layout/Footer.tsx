  ...
  return (
    <footer className="border-t border-white/10 bg-slate-950/80">
      <div className="container-shell grid gap-10 py-12 md:grid-cols-4">
        <div>
          <div className="mb-4 text-xl font-bold text-white">PLfit</div>
          <p className="text-sm text-slate-400">Train better. Eat better. Live better.</p>
        </div>
        <div>
      ...
      <div className="border-t border-white/10 py-4 text-center text-sm text-slate-500">
        © 2026 PLfit. All rights reserved.
      </div>
    </footer>
  );
}
